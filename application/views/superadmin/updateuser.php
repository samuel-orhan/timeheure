<div class="g12">
    ...
    <?php echo form_open("", array('id' => 'form', 'autocomplete' => 'off'));?>
        ...
        <fieldset>
            ...
            <section>
                <label for="group">Choisissez le(s) rôle(s) à assigner<br><span>plusieurs rôles peuvent être assignés à la même personne.</span></label>
                <div>
                    <?php echo form_multiselect('group[]', $role, $group_selected);?>
                </div>
            </section>
        </fieldset>
