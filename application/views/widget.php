    ...
    <body>
        ...
        <section id="content">
            ...
            <div class="g12 nodrop">
                <h1>Widgets <span><a href="doc-widget.html" class="small">Documentation</a></span></h1>
                <p>Widgets are flexible, dragg-, sort-, and collapseable content boxes.<br>
                    There position get stored with <code>LocalStorage</code>. You can <a class="clearLocalStorage">clear the LocalStorage</a> to restore the defaults (requires page refresh)</p>
            </div>
            ...
            <div class="g4 widgets">
                ...
                <div class="widget number-widget" id="number_widget">
                    <h3 class="handle">Number Widget</h3>
                    <div>
                        <ul>
                ...
                <div class="widget" id="ajax_widget" data-load="widget-content.php">
                    <h3 class="handle">AJAX Widget</h3>
                    <div>
                        This content get replaced
                    </div>
                </div>

                <div class="widget" id="ajax_widget_reload" data-load="widget-content.php" data-reload="5" data-remove-content="false">
            ...
            <div class="g4 widgets">
                <div class="widget" id="calendar_widget" data-icon="calendar">
                    <h3 class="handle">Calendar Widget</h3>
                    <div>
                        <div class="calendar" data-header="small"></div>
                    </div>
                </div>
                <div class="widget" id="widget_collapsed" data-collapsed="true">
                    <h3 class="handle">Collapsed by default</h3>
                    <div>
                ...
                <div class="widget" id="widget_fixed" data-sortable="false">
                    <h3 class="handle">Fixes</h3>
                    <div>
                        <h3>This widget is fixed!</h3>
                        <p>Since version 1.1 it's possible to fix widgets with <code>data-sortable="false"</code>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="g12 widgets">
                ...
                <div class="widget" id="widget_icon" data-icon="airplane">
                    <h3 class="handle">data-icon="airplane"</h3>
                    <div>
                        <h3>Specify one of over 400 Icons</h3>
                    </div>
                </div>
                <div class="widget" id="widget_markup">
                    <h3 class="handle">Simple Markup!</h3>
                    <div>
                        <pre>
...
&lt;/div&gt;</pre>
            ...
            <div class="g6 widgets">
                ...
                <div class="widget" id="widget_tabs">
                    <h3 class="handle">Tabs Widget</h3>
                    <div class="tab">
                        <ul>
            ...
            <div class="g6 widgets">
                ...
                <div class="widget" id="widget_accordion">
                    <h3 class="handle">Accordion Widget</h3>
                    <div class="accordion">
